...
/**
 * Servlet implementation class ServletLivreList
 */
@WebServlet("/listlivres")
public class ServletLivreList extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ServletLivreList() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Config.getInstance();
		CrudLivresInterface crudlivres = new CrudLivres();
		List<Livre> listlivre = crudlivres.lister();
		Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
		String json = gson.toJson(listlivre);
